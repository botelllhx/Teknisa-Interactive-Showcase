...
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    description:
      "Centraliza solicitações de compras, contratos e pedidos com fluxo Pendentes → Aprovadas / Reprovadas, diff de valores e comentário no histórico.",
    device: "desktop",
    icon: "BadgeCheck",
    tags: ["Aprovação", "Workflow", "Compras"],
    companions: ["MiniDashboard"],
    status: "ready",
  },
